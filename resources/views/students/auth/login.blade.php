...
<head>
    ...
    <!-- Title -->
    <title>Вход в систему | Students</title>
</head>
            ...
            Free access to our dashboard.
                ...
                <form action="{{ route('students.login') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Input -->
                        <input name="passport_number" type="text" class="form-control @error('passport_number') is-invalid @enderror" placeholder=" Введите имя пользователя" autofocus>
