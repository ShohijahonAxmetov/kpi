                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" id="title" placeholder="Заголовок...">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    <!-- Dropzone -->
                                    <label for="dropzone" class="form-label text-capitalize">Иконка</label>
