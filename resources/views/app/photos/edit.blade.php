...
@section('content')
    ...
    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('photos.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">photos</a> >> <a class="d-flex text-uppercase ms-2">edit</a>
    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <div class="my-4">
                                                ...
                                                <textarea class="form-control" placeholder="Enter your description..." id="textarea" rows="4" name="desc[{{ $language->small }}]">{{ old('desc.'.$language->small) ? old('desc.'.$language->small) : $photo->desc[$language->small] }}</textarea>
                                            </div>
                                            <!-- End of Form -->
                                        </div>
                                    </div>
