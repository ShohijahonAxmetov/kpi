            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" style="width: 100px">{{ $feedbacks->firstItem() + $key }}</th>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="imb-block me-2 overflow-hidden">
                                        <img src="{{ isset($item->img) ? $item->sm_img : asset('assets/img/default.png') }}" alt="">
                                    </div>
                                    {{ $item->name[$main_lang->code] }}
                                </div>
                            </td>
                            <td>{!! $item->feedback[$main_lang->code] !!}</td>
