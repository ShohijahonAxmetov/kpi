                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" {{ $lang->code == $main_lang->code ? 'required' : '' }} class="form-control @error('name.'.$lang->code) is-invalid @enderror" name="name[{{ $lang->code }}]" value="{{ old('name.'.$lang->code) ?? $feedback->name[$lang->code] }}" id="name.{{ $lang->code }}" placeholder="Ф.И.О....">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="feedback[{{ $lang->code }}]" id="feedback_{{ $lang->code }}" cols="30" rows="10" class="form-control @error('feedback.'.$lang->code) is-invalid @enderror ckeditor" name="feedback[{{ $lang->code }}]" placeholder="Отзыв..." {{ $lang->code == $main_lang->code ? 'required' : '' }}>{{ old('feedback.'.$lang->code) ?? $feedback->feedback[$lang->code] }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('position.'.$lang->code) is-invalid @enderror" name="position[{{ $lang->code }}]" value="{{ old('position.'.$lang->code) ?? $feedback->position[$lang->code] }}" id="position" placeholder="Позиция...">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link" value="{{ old('youtube_link') ?? $feedback->youtube_link }}" id="youtube_link" placeholder="link...">
                                    @error('youtube_link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') ?? $feedback->link }}" id="link" placeholder="link...">
                                    @error('link')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
