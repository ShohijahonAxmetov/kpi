    ...
    <div class="groups">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route($route_name.'.edit', [$route_parameter => $group->id]) }}" class="d-flex p-1 mt-4" style="width: max-content;text-decoration: underline;"><i class="fe fe-edit-2 d-flex align-items-center justify-content-center" style="width: 20px;height:20px"></i> редактировать</a>
            </div>
        </div>
    </div>
    <div class="card mt-4">
