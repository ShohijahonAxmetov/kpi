...
<!-- CARDS -->
<div class="container-fluid">
    <form method="post" action="{{ route($route_name . '.update', [$route_parameter => $direction]) }}" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control @error('university_id') is-invalid @enderror" data-choices name="university_id" id="university_input">
                                        ...
                                        <option value="{{ $item->id }}" {{ old('university_id', $direction->university_id) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('university_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="form-control mb-4 @error('faculty_id') is-invalid @enderror" name="faculty_id" id="faculty_input">
                                        ...
                                        <option data-parent="{{ $item->university_id }}" value="{{ $item->id }}" {{ old('faculty_id', $direction->faculty_id) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('faculty_id')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $direction->title) }}" id="title" placeholder="Заголовок...">
                                    @error('title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $direction->code) }}" id="code" placeholder="Код...">
                                    @error('code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
