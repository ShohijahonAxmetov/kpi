                ...
                <table class="table table-sm table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Asos yuklanishi kerakmi?</th>
                            <th scope="col">Mezon bo'limi</th>
                            <th scope="col"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->is_need_basis == true ? "Ha" : "Yo'q" }}</td>
                            <td>{{ $item->criterion->criterionCategory->criterionMainCategory->name }} -> {{ $item->criterion->criterionCategory->name }} -> {{ $item->criterion->name }}</td>
