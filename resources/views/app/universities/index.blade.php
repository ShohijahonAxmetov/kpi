                ...
                <table class="table table-sm table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Где расположен (регион/район)</th>
                            <!-- <th scope="col">Средняя значения потенциала (KPI) студентов</th> -->
                            <!-- <th scope="col">Максимальное значение потенциала студентов ВУЗа</th> -->
                            <th scope="col"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" style="width: 100px">{{ $universities->firstItem() + $key }}</th>
                            <td>{{ $item->title }}</td>
                            <td>{{ $item->region->name.'/'.($item->district->name ?? '-') }}</td>
                            <td style="width: 200px">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route($route_name.'.show', [$route_parameter => $item]) }}" class="btn btn-sm btn-success"><i class="fe fe-eye"></i></a>
