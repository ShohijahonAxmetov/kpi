        ...
        <div class="card-body">
            <form action="{{ route($route_name.'.index') }}" method="get" class="d-flex justify-content-end w-100">
                <div class="form-group mb-0 w-100">
                    <select class="form-control @error('university_id') is-invalid @enderror" data-choices name="university_id">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" style="width: 100px">{{ $faculties->firstItem() + $key }}</th>
                            <td>{{ $item->title }}</td>
