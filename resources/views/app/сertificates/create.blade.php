...
@section('content')
    ...
    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('certificates.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">Сертификаты</a> >> <a class="d-flex text-uppercase ms-2">Добавить</a>
    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success px-5 text-white" type="submit" style="padding:12px">Сохранить</button>
                    </div>
                </div>
            </div>
        </div>
