...
@section('content')
    ...
    <h1 class="text-uppercase mt-5">Сертификаты</h1>

    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('certificates.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">Сертификаты</a> >> <a class="d-flex text-uppercase ms-2">редактировать</a>
    </div>
            ...
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <div class="my-4">
                                                ...
                                                <textarea class="form-control" placeholder="Enter your description..." id="textarea" rows="4" name="desc[{{ $language->small }}]">{{ old('desc.'.$language->small) ? old('desc.'.$language->small) : $certificate->desc[$language->small] }}</textarea>
                                            </div>
                                            <!-- End of Form -->
                                        </div>
                                    </div>
                        ...
                        <button class="btn btn-success px-5" type="submit" style="padding:12px">Сохранить</button>
                    </div>
                </div>
            </div>
        </div>
